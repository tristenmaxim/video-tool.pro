...
class TechnicalVideoAnalyzer:
    ...
    def analyze_with_vision(self, grid_image, abstract_grid, transcription="", job_context=True):
        ...
        prompt = (
            "As part of my job application assessment for an AI/ML/cybersecurity position, I need to "
            ...
            "2) Key interface elements and their functions "
            "3) The overall process being shown "
            ...
            "This analysis will demonstrate my ability to extract meaningful technical insights "
            "from video content for cybersecurity applications."
        )
            ...
            messages = [
                {
                    "role": "system",
                    "content": (
                        "You are a technical UI/UX analysis assistant for a job application assessment. "
                        "Focus only on analyzing interface elements, workflow processes, and technical "
                        "structures shown in the abstracted representation. Your analysis should be "
                        "detailed, technical, and suitable for a cybersecurity role application. "
                        "Avoid making any judgments about the content itself."
                    )
                },
                {
                    "role": "user",
    ...
    def _perform_technical_analysis(self, transcription):
        ...
        analysis += "This analysis is performed as part of my job application for an AI/ML/cybersecurity position. It demonstrates my ability to extract structured information from video content for security analysis purposes.\n\n"
        ...
        if transcription:
            ...
            analysis += "\nThis analysis demonstrates my capability to extract structured workflow information from video content, which is essential for security monitoring, threat assessment, and vulnerability analysis in cybersecurity applications."
    ...
    def summarize(self, analysis_text, model="gpt-4o"):
        ...
        prompt = (
            "As part of my job application for an AI/ML/cybersecurity position at a major corporation "
            "that works with government agencies, I need to create a professionally formatted summary "
            "of this technical video analysis. Please create a concise, well-structured summary "
            "focusing on the technical workflow, interface elements, and process steps identified. "
            "This summary should demonstrate my ability to extract and communicate technical insights "
            "from video content, which is critical for the security analysis role I'm applying for.\n\n"
        ) + analysis_text
    ...
    def _create_technical_summary(self, analysis_text):
        ...
        summary += "This summary demonstrates my technical video analysis capabilities for the cybersecurity position:\n\n"
        ...
        summary += "\nThis analysis demonstrates my capability to extract structured information from video content, essential for security monitoring and threat assessment in cybersecurity applications."
